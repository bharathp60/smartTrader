...
//                BigDecimal equity = parseBigDecimal(body.get("equity"));
//                BigDecimal buyingPower = parseBigDecimal(body.get("buying_power"));
//                BigDecimal usedMargin = equity.subtract(buyingPower.min(equity));
//                BigDecimal unrealizedPnl = parseBigDecimal(body.get("unrealized_pl"));
...
//            String side = "BUY".equalsIgnoreCase(String.valueOf(request.side())) ? "buy" : "sell";
//
...
//                body.put("limit_price", request.limitPrice().toPlainString());
//            }
//            if (request.stopPrice() != null) {
//                body.put("stop_price", request.stopPrice().toPlainString());
//            }
//
...
//                    request.symbol(),
//                    mapAlpacaStatus(String.valueOf(data.get("status"))),
//                    parseBigDecimal(data.get("filled_qty")),
//                    parseBigDecimal(data.get("qty")),
//                    parseBigDecimal(data.get("filled_avg_price")),
//                    Instant.now()
//                );
//            }
//        } catch (Exception e) {
...
//            OrderStatus.REJECTED, BigDecimal.ZERO, BigDecimal.ZERO, BigDecimal.ZERO, Instant.now()
//        );
//    }
//
//    @Override
...
//                    clientOrderId,
//                    String.valueOf(data.get("id")),
//                    String.valueOf(data.get("symbol")),
//                    mapAlpacaStatus(String.valueOf(data.get("status"))),
//                    parseBigDecimal(data.get("filled_qty")),
//                    parseBigDecimal(data.get("qty")),
//                    parseBigDecimal(data.get("filled_avg_price")),
...
//            }
//        } catch (Exception e) {
//            log.error("Failed to fetch order {} from Alpaca: {}", clientOrderId, e.getMessage());
//        }
//        return null;
//    }
//
...
//                baseUrl + "/orders?status=open",
//                HttpMethod.GET,
//                new HttpEntity<>(buildHeaders()),
//                List.class
//            );
//            if (resp.getStatusCode().is2xxSuccessful()) {
//                return List.of(); // parse in production
//            }
//        } catch (Exception e) {
//            log.error("Failed to fetch open orders from Alpaca: {}", e.getMessage());
//        }
//        return List.of();
//    }
//
...
//            return resp.getStatusCode().is2xxSuccessful();
//        } catch (Exception e) {
//            log.error("Failed to cancel order {} on Alpaca: {}", clientOrderId, e.getMessage());
//            return false;
//        }
//    }
//
...
//    }
//
//    private OrderStatus mapAlpacaStatus(String status) {
